    ...
    <Navbar2/>
      <div className='search-part'>
        ...
        <div className="blogcard">
          <div className="blogc">
            <img src="/blog2.jpg" alt="kabhins"></img>
            <p style={{textAlign:"center"}}>Create your own blogs</p>
          </div>
          <div className="blogc">
          <img src="/blog3.avif" alt="kabhins"></img>
          <p>Make it available to everyone</p>
          </div>
          <div className="blogc">
          <img src="/blogimage.jpg" alt="kabhins"></img>
          <p>Quality of sharing</p>
          </div>
          <div className="blogc">
          <img src="/cret.webp" alt="kabhins"></img>
          <p>Create your own blogs</p>
          </div>
          <div className="blogc">
          <img src="/crting.webp" alt="kabhins"></img>
          <p>Create your own blogs</p>
          </div>
        </div>
      </div>
